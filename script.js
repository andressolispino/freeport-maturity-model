    ...
    feedbackDiv.innerHTML = `
            <div class="ai-feedback-title-row">
              ...
              <span class="ai-source-badge" title="Modelo de lenguaje utilizado">
                <i class="fas fa-bolt"></i> Groq · ${escapeHTML(GROQ_MODEL)}
              </span>
            </div>
...
// El informe mostrado al usuario se genera exclusivamente mediante Groq.
...
function buildGroqAnalysisPrompt(payload) {
